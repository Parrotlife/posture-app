...
class BoxingRobotDemo(ShowBase):
    ...
    def draw(self):
        ...
        #add the peak of the polygone
        vertex.addData3f(self.pos.getX(), self.pos.getY(), self.pos.getZ()-10)
        color.addData4f(self.color)
    ...
    def __init__(self):
        ...
        self.disableMouse()
        camera.setPosHpr(14.5, -15.4, 0, 45, -14, 0)
        self.setBackgroundColor(0, 0, 0)
        self.enableMouse()

        self._EDGES = 3
        self.pos = LVecBase3f(0,0,0)
        self.color = (0.8, 0.0, 0.3, 1.0)
        self.size = 1
        ...
        # Load the ring
        self.ring1 = self.draw()
        self.ring1.reparentTo(render)
        # self.ring1.setPosHprScale(0, 0, 0, 0, 0, 0, 1., 1., 10.)
        # self.ring2 = loader.loadModel('models/triangle.dae')
        # self.ring2.setPosHprScale(0, 0, 0, 0, 0, 90, 1., 1., 1.)
        # self.ring2.reparentTo(self.ring1)
